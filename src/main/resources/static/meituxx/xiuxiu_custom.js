...
var swfobject = function () {
    var D = "undefined",
        ...
        n, G, m = true,
        M = function () {
            var aa = typeof j.getElementById != D && typeof j.getElementsByTagName != D && typeof j.createElement !=
                D,
        ...
        k = function () {
            ...
            if ((typeof j.readyState != D && j.readyState == "complete") || (typeof j.readyState == D && (j.getElementsByTagName(
                    "body")[0] || j.body))) {
                f()
            }
            if (!J) {
    ...
    function P(aa, ab, X, Z) {
        ...
        if (ae) {
            ...
            var ad = M.ie && M.win ? "ActiveX" : "PlugIn",
                ac = "MMredirectURL=" + encodeURI(window.location).toString().replace(/&/g, "%26") +
    ...
    function u(ai, ag, Y) {
        ...
        if (aa) {
            ...
            if (M.ie && M.win) {
                ...
                aa.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + ah + ">" + af +
                    "</object>";
                N[N.length] = ai.id;
                X = c(ai.id)
            } else {
...
xiuxiu.protocol = document.location.protocol == "https:" ? "https:" : "http:";
xiuxiu.minFlashVersion = "10.2.0";
xiuxiu.lightEditor = xiuxiu.lightEditor || {
    url: xiuxiu.protocol + "//open.web.meitu.com/sources/light/PhotoEditor.swf?version=201410201425",
    base: xiuxiu.protocol + "//open.web.meitu.com/sources/light/",
    width: "528",
    height: "385",
    type: 1
};
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {
    url: xiuxiu.protocol + "//open.web.meitu.com/sources/puzzle/CollagePlugin.swf?version=201305211645",
    base: xiuxiu.protocol + "//open.web.meitu.com/sources/puzzle/",
    width: "528",
    height: "470",
    type: 2
};
xiuxiu.richEditor = xiuxiu.richEditor || {
    url: xiuxiu.protocol + "//xiuxiu.web.meitu.com/Main.swf?v=2.6.111",
    base: xiuxiu.protocol + "//xiuxiu.web.meitu.com/",
    width: "100%",
    height: "100%",
    type: 3
};
xiuxiu.daitoutie = xiuxiu.daitoutie || {
    url: xiuxiu.protocol + "//open.web.meitu.com/sources/daitoutie/FacePhoto.swf?version=201304251419",
    base: xiuxiu.protocol + "//open.web.meitu.com/sources/daitoutie/",
    width: "568",
    height: "478",
    type: 4
};
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {
    url: xiuxiu.protocol + "//open.web.meitu.com/sources/avatar/avatar.swf?version=201410201414",
    base: xiuxiu.protocol + "//open.web.meitu.com/sources/avatar/",
    width: "700",
    height: "435",
    type: 5
};
xiuxiu.batchEditor = xiuxiu.batchEditor || {
    url: xiuxiu.protocol + "//xiuxiu.web.meitu.com/plugin/batch/plugin.swf?version=201405281142",
    base: xiuxiu.protocol + "//xiuxiu.web.meitu.com/plugin/batch/",
    width: "700",
    height: "435",
    type: 6
};
...
xiuxiu.embedSWF = function (b, c, f, m, e) {
    ...
    if (document.getElementById(xiuxiu.container)) {
        document.getElementById(xiuxiu.container).innerHTML = '<p><a href="' + xiuxiu.protocol +
            '//www.adobe.com/go/getflashplayer"><img alt="Get Adobe Flash player" src="' + xiuxiu.protocol +
            '//wwwimages.adobe.com/www.adobe.com/images/shared/download_buttons/get_flash_player.gif"></a></p>'
    }
    ...
    swfobject.embedSWF(a, xiuxiu.container, f, m, g, xiuxiu.protocol +
        "//open.web.meitu.com/sources/expressInstall.swf", h, l, xiuxiu.attributes);
    xiuxiu.swfs.push({
...
xiuxiu._uploadResponse = function (a, b) {
    if (xiuxiu.onUploadResponse && typeof (xiuxiu.onUploadResponse) == "function") {
        xiuxiu.onUploadResponse(a, b);
        xiuxiu._apiTrack("onUploadResponse", b, true)
    }
};
xiuxiu._batchUploadResponseFun = function (b, a, c) {
    if (xiuxiu.onBatchUploadResponse && typeof (xiuxiu.onBatchUploadResponse) == "function") {
...
xiuxiu._batchUploadCompleteFun = function (a) {
    if (xiuxiu.onBatchUploadComplete && typeof (xiuxiu.onBatchUploadComplete) == "function") {
        xiuxiu.onBatchUploadComplete(a);
        xiuxiu._apiTrack("onBatchUploadComplete", a, true)
    }
};
xiuxiu._saveBase64Image = function (b, d, a, c) {
    if (xiuxiu.onSaveBase64Image && typeof (xiuxiu.onSaveBase64Image) == "function") {
...
xiuxiu.setUploadArgs = function (a, b) {
    xiuxiu.uploadArgs = a;
    if (xiuxiu.uploadArgs && xiuxiu.getEditor(b) && xiuxiu.getEditor(b).setParam) {
...
xiuxiu.setUploadType = function (a, b) {
    xiuxiu.uploadType = a;
    if (xiuxiu.uploadType && xiuxiu.getEditor(b) && xiuxiu.getEditor(b).setParam) {
...
xiuxiu.setUploadDataFieldName = function (a, b) {
    ...
    if (xiuxiu.uploadDataFieldName && xiuxiu.getEditor(b) && xiuxiu.getEditor(b).setParam) {
